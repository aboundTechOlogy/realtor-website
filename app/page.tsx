          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                ...
                className="inline-block bg-primary text-white px-12 py-4 rounded-lg text-lg font-semibold hover:bg-primary-dark transition-colors whitespace-nowrap"
              >
                Get Your Free Market Reality Check
              </Link>
              <Link
                href="/listings"
                className="inline-block bg-white text-primary px-12 py-4 rounded-lg text-lg font-semibold hover:bg-gray-100 transition-colors whitespace-nowrap"
              >
